...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Wo würdest du gerne starten?"><p><span id="null">Wo würdest du gerne starten?</span></p></div>')
    
    setTimeout(function(){
        $(parent).append('<div class="location" id="location" data-location="current" data-type="current" data-label="Letzter Aufenthaltsort"><p><span id="current-location">Letzter Aufenthaltsort</span></p></div>');
...
function setupApps(apps) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Wähle ein Apartment"><p><span id="null">Wähle ein Apartment</span></p></div>')
